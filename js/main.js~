var app = {
	...
	$.get('http://localhost:8182/discoveragent/upnp?devicedetails&device=5', function(data) {
		//it works, do something with the data
		$('#getzaharra .details').append('<br><div>http://localhost:8182/discoveragent/upnp?devicedetails&device=5</div><br><div>'+data+'</div>');
	});
	$.get('http://localhost:8182/discoveragent/upnp?services?device=5', function(data) {
		//it works, do something with the data
		$('#getzaharra .services').append('<br><div>http://localhost:8182/discoveragent/upnp?services&device=5</div><br><div>'+data+'</div>');
	});

	$.get('http://localhost:8182/discoveragent/upnp?actions&device=5&service=RenderingControl', function(data) {
		//it works, do something with the data
		$('#getzaharra .actions').append('<br><div>http://localhost:8182/discoveragent/upnp?actions&device=5&service=RenderingControl</div><br><div>'+data+'</div>');
	});

	$.get('http://localhost:8182/discoveragent/upnp?parameters&device=5&service=RenderingControl&action=SetVolume', function(data) {
		//it works, do something with the data
		$('#getzaharra .parameters').append('<br><div>http://localhost:8182/discoveragent/upnp?parameters&device=5&service=RenderingControl&action=SetVolume</div><br><div>'+data+'</div>');
	});
	...
	$.get('http://localhost:8182/discoveragent/upnp?devicedetails&device=5', function(data) {
		//it works, do something with the data
		$('#getberria .details').append('<br><div>http://localhost:8182/discoveragent/upnp?devicedetails&device=5</div><br><div>'+data+'</div>');
	});
	$.get('http://localhost:8182/discoveragent/upnp/services?device=5', function(data) {
		//it works, do something with the data
		$('#getberria .services').append('<br><div>http://localhost:8182/discoveragent/upnp/services?device=5</div><br><div>'+data+'</div>');
	});

	$.get('http://localhost:8182/discoveragent/upnp/actions?device=5&service=RenderingControl', function(data) {
		//it works, do something with the data
		$('#getberria .actions').append('<br><div>http://localhost:8182/discoveragent/upnp/actions?device=5&service=RenderingControl</div><br><div>'+data+'</div>');
	});
