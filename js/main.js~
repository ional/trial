var app = {
	...
	$('#javascript .parameters').append('<br><div>'+window.discovery.parameters(4, "RenderingControl", "SetVolume")+'</div>');

	$('#javascript .screenSize').append('<br><div>'+window.discovery.screenSize()+'</div>');
	$('#javascript .geolocation').append('<br><div>'+window.discovery.geolocation()+'</div>');
	$('#javascript .orientation').append('<br><div>'+window.discovery.orientation()+'</div>');
	$('#javascript .media').append('<br><div>'+window.discovery.media()+'</div>');
	$('#javascript .vibration').append('<br><div>'+window.discovery.vibration()+'</div>');
	$('#javascript .battery').append('<br><div>'+window.discovery.battery()+'</div>');
	$('#javascript .userProximity').append('<br><div>'+window.discovery.userProximity()+'</div>');
	$('#javascript .deviceProximity').append('<br><div>'+window.discovery.deviceProximity()+'</div>');
    }
};
console.log("Trial");
app.initialize();
