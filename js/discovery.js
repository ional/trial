var dicovery = {
	...
	orientation: function(){
		if (window.DeviceOrientationEvent) {
			...
			/* window.addEventListener("deviceorientation", function(event) {
			 ...
			 alert('Orientation detect is not supported in your browser');
		}
	},
	media: function(){
	...
	vibration: function(){
		if(navigator.vibrate || navigator.webkitVibrate || navigator.mozVibrate || navigator.msVibrate){
			...
			return "Vibration";
		} else 'Vibration is not supported in your browser.';
	},
	battery: function(){
		if(navigator.battery || navigator.webkitBattery || navigator.mozBattery)
		{
			...
			return "Battery";
		} else 'Battery status is not supported in your browser.';
	},
	userProximity: function(){
		if(window.DeviceProximityEvent){
			return 'Device Proximity Event';
		} else 'DeviceProximityEvent status is not supported in your browser.';
	},
	deviceProximity: function(){
		if(window.UserProximityEvent){
			return 'User Proximity Event';
		} else 'UserProximityEvent status is not supported in your browser.';
	}
